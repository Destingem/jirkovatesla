...
export default function SluzbaCard({
 ...
 if(device !== "l"){
  ...
  return (
    <div style={{ backgroundColor: backgroundColor, display: "flex", margin: "0 10vw" }}>
   ...
   <div
    ...
    >
        ...
        <Divider
          sx={{ marginTop: "2vh", width: "100%", position: "" }}
          size={"xl"}
          color={color ? color : theme.colors.teal[6]}
        />
            </div>
        <Text size={"xl"} color={theme.colors.neutral[0]}  sx={{ padding: "2vh 10vw 0 0", lineHeight: "175%", marginTop: "2vh" }}>{desc}</Text>
      </div>
   </div>
      <div
        style={{
