...
export default function Navbar({motion}) {
 ...
 const [sluzbyOpen, setSluzbyOpen] = useState(false);
  ...
  let backgroundColor = "rgb(255, 118, 118)"
  let cardColor = "light"
            ...
            >
              <div className={classes.linksContainer}>
                {menuItems.map((link, index) => {
                  ...
                  return <LaptopBigMenu classN={classes} textColor={textColor } scroll={scroll} itemsSluzby={link.items}/>
                  }
                })}
              </div>
            </Grid.Col>
            <Grid.Col span={3} sx={{display: "flex", alignItems: "center", justifyContent: "flex-end"}}>
