   ...
   if(device !== "l"){
    return (
      <section style={{ padding: "5vh 10vw", display: "flex", flexDirection: "column", gap: "4vh" }}>
          <SubTitle style={{}} href={"/o-nas"} device={device} label={"HODNOCENÍ"}>Naši zákazníci</SubTitle>
    ...
    return(
        <div style={{ display: "flex", flexDirection: "column", gap: "3vh" }}>
            <SubTitle style={{margin: "0 10vw"}} href={"#"} device={device} label={"RECENZE"}>Hodnocení zákazníky</SubTitle>
